...
export default {
    ...
    methods: {
        addContent() {
            this.$emit('addContentLastChild')
        },
        deleteContent(obj){
            this.$emit('deleteContentLastChild',obj);
        }
    },
}
</script>
